    ...
    <div class="text-black m-5">
        ...
        <form action="{{ url('actors/addactor') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control text-white" id="biography" name="biography"rows="5"></textarea>
                @error('biography')
                    {{ $message }}
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="date" class="form-control text-white" id="dob" name="dobActor"></input>
                @error('dobActor')
                    {{ $message }}
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control text-white" type="file" id="image" placeholder="No file choosen"
                    name="actorimage">
                @error('actorimage')
                    {{ $message }}
                @enderror
